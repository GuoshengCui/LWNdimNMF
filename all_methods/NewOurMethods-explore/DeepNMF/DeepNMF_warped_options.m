function [W,H,Ht,Hc] = DeepNMF_warped_options(X,gnd,G,options)
...
for inmf = 1:num_nmf 
    tic 
    [Z,H,Hend,Hc,lwndimnmf_obj] = DeepNMF(fea,paras);W = Z;
%     [Z,H,Hend,Hc,lwndimnmf_obj] = DeepNMF_2layers(fea,paras);W = Z;
    toc
    if ~isempty(Hend)
