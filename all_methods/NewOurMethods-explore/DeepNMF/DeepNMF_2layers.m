function [Z,H,Hend,Hc,obj] = DeepNMF_2layers(X,options)
    ...
    for v = 1:n_view
        ...
        for ilayer = 1:n_layer
            ...
            elseif ilayer == 2
                ...
                fenzi = psi'*X{v}*phi' + ...
                    alpha*Z{v,2}*H{v}*S{v}*H{v}';
                fenmu = psi'*psi*Z{v,ilayer}*(phi*phi') + ...
                    alpha*Z{v,2}*H{v}*D{v}*H{v}';
        ...
        fenzi = psi'*X{v} + alpha*H{v}*S{v} + ...
            alpha*Z{v,2}'*Z{v,2}*H{v}*S{v} + beta*Hc*G{v}';
        fenmu = psi'*psi*H{v} + alpha*H{v}*D{v} + ...
            alpha*Z{v,2}'*Z{v,2}*H{v}*D{v} + beta*H{v};
